class AlarmClock {
  ...
  start(){
    ...
    this.intervalId = setInterval(this.alarmCollection.forEach(elem => (elem.time === this.getCurrentFormattedTime() && elem.canCall) ? (elem.canCall = false, elem.callback()): elem))
  }
  stop(){
